...
<p align="justify">O principal objetivo deste documento é mostrar todas as avaliações de sites feitas pelos integrantes do projeto que foram a decisão de escolha para o  <a href="https://interacao-humano-computador.github.io/2021.2-Prefeitura-Verdelandia/documentos/01-Planejamento-e-Processo/SiteEscolhido/">site escolhido</a>.</p>
...
<p align="justify">O site  <a href="https://sig.unb.br/sigaa/verTelaLogin.do">SIGAA-UnB</a> é um sistema com diversas funcionalidades, como a entrega de notas, controle de presenças, comunicações, emissão de certificados, fórum e diversas outras funcionalidades.<br>
...
<p align="justify">O site da <a href="http://www.verdelandia.mg.gov.br">Prefeitura de Verdelândia-MG</a> contém notícias sobre a cidade, serviços online, informações uteis e sobre secretárias, além de dar acesso ao portal da transparência da cidade.<br>
...
<p align="justify">
O site  <a href="https://loldodgegame.com/">LolDodge</a> game é um jogo com objetivo de ajudar os jogadores de League of Legends a treinar suas habilidades de movimentação no jogo.<br>
Segundo a avaliação de Valderson, os principais problemas de usabilidade são o tempo de carregamento do site e a movimentação do personagem nos jogos.
</p>
<br></br>


## 2.4 **Polícia Civil do Distrito Federal**
...
<p align="justify"> O site da  <a href="https://www.pcdf.df.gov.br/">Polícia Civil do Distrito Federal</a> oferece vários serviços ao cidadão, assim como informações sobre as unidades policiais, notícias gerais, disk denúncia e entre outros.<br>
...
## 2.5 **Polícia Civil do Distrito Federal**
...
<p align="justify"> O site  <a href="https://www.therpc.studio/">RPC Studio</a> é um site que trabalha com vendas de fantasias dos mais diversos heróis e de alta qualidade.
<br>
...
## 4. Conclusão
<p align="justify">Com a escolha dos sites e o uso da votação pelos integrantes do grupo este documento foi de extrema importância para a escolha do site usado para desenvolver este projeto.</p>
